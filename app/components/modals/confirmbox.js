  ...
  return (
     <>
       <div className=' h-full flex justify-center items-center '>
           <div className='w-auto h-auto p-6 rounded-2xl shadow-lg shadow-gray-600 bg-modalFace z-10 opacity-100 fixed   '>
             <div className="  pt-5 pb-5 px-3 w-auto h-auto rounded-2xl bg-white flex justify-center items-center flex-col"> 
                  ...
                  <h4 className="font-semibold text-2xl text-darkRed">{id} <span className="text-black">?</span></h4> 
            </div>   
